                    ...
                    <table className="w-full text-left text-xs">
                        <thead className="bg-black/40 text-gray-400 font-bold uppercase tracking-wider text-[10px] border-b border-white/5">
                            <tr>
                                ...
                                <th className="px-5 py-3.5">Extra Time</th>
                                    ...
                                    <tr key={s.id} className="hover:bg-white/[0.02] transition">
                                        ...
                                        <td className="px-5 py-4 text-gray-400">
                                            {s.scheduled_start
                                                ...
                                                : <span className="italic text-gray-600">Immediate</span>}
                                        </td>
                                        ...
                                        <td className="px-5 py-4">
                                            ...
                                            >
                                                {s.paper_generated ? '75 Qs Locked' : 'Not Generated'}
                                            </span>
                                        </td>
                                        <td className="px-5 py-4 font-mono font-semibold text-orange-400">
                                            {s.extra_time_min > 0 ? `+${s.extra_time_min}m` : '0m'}
                                        </td>
